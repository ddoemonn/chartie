...
var BarChart = class {
  ...
  render(ctx, bounds, progress) {
    ...
    if (!this.config.data.datasets.length)
      return;
    const scalesOptions = (_a = this.config.options) == null ? void 0 : _a.scales;
    const legendHeight = ((_c = (_b = this.config.options) == null ? void 0 : _b.legend) == null ? void 0 : _c.display) ? 50 : 0;
    const chartBounds = {
      x: bounds.x + 50,
    ...
    if ((_e = (_d = this.config.options) == null ? void 0 : _d.legend) == null ? void 0 : _e.display) {
      this.renderLegend(ctx, bounds);
    }
    if (((_g = (_f = scalesOptions == null ? void 0 : scalesOptions.x) == null ? void 0 : _f.grid) == null ? void 0 : _g.display) || ((_i = (_h = scalesOptions == null ? void 0 : scalesOptions.y) == null ? void 0 : _h.grid) == null ? void 0 : _i.display)) {
  ...
  renderLegend(ctx, bounds) {
    ...
    const legendOptions = (_a = this.config.options) == null ? void 0 : _a.legend;
    if (!(legendOptions == null ? void 0 : legendOptions.display))
      return;
    const colors = getColorArray(defaultColors, this.config.data.datasets.length);
    let x = bounds.x + 20;
    const y = bounds.y + 15;
    ctx.font = `${((_c = (_b = legendOptions.labels) == null ? void 0 : _b.font) == null ? void 0 : _c.size) || 12}px ${((_e = (_d = legendOptions.labels) == null ? void 0 : _d.font) == null ? void 0 : _e.family) || "Arial"}`;
    ctx.fillStyle = ((_f = legendOptions.labels) == null ? void 0 : _f.color) || "#333";
    this.config.data.datasets.forEach((dataset, index) => {
      ...
      ctx.fillStyle = ((_a2 = legendOptions.labels) == null ? void 0 : _a2.color) || "#333";
  ...
  renderGrid(ctx, bounds) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _i;
    const scalesOptions = (_a = this.config.options) == null ? void 0 : _a.scales;
    ctx.strokeStyle = ((_c = (_b = scalesOptions == null ? void 0 : scalesOptions.y) == null ? void 0 : _b.grid) == null ? void 0 : _c.color) || "rgba(0,0,0,0.1)";
    ctx.lineWidth = ((_e = (_d = scalesOptions == null ? void 0 : scalesOptions.y) == null ? void 0 : _d.grid) == null ? void 0 : _e.lineWidth) || 1;
    if ((_g = (_f = scalesOptions == null ? void 0 : scalesOptions.y) == null ? void 0 : _f.grid) == null ? void 0 : _g.display) {
      const gridLines = 5;
    ...
    if (((_i = (_h = scalesOptions == null ? void 0 : scalesOptions.x) == null ? void 0 : _h.grid) == null ? void 0 : _i.display) && this.config.data.labels) {
  ...
  renderAxes(ctx, bounds) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _i;
    const scalesOptions = (_a = this.config.options) == null ? void 0 : _a.scales;
    if ((_b = scalesOptions == null ? void 0 : scalesOptions.y) == null ? void 0 : _b.display) {
      ctx.strokeStyle = "#333";
      ctx.lineWidth = 1;
      ctx.beginPath();
      ...
      ctx.stroke();
      if ((_c = scalesOptions.y.ticks) == null ? void 0 : _c.display) {
        ctx.fillStyle = scalesOptions.y.ticks.color || "#666";
        ctx.font = `${((_d = scalesOptions.y.ticks.font) == null ? void 0 : _d.size) || 10}px ${((_e = scalesOptions.y.ticks.font) == null ? void 0 : _e.family) || "Arial"}`;
        ctx.textAlign = "right";
    ...
    if ((_f = scalesOptions == null ? void 0 : scalesOptions.x) == null ? void 0 : _f.display) {
      ctx.strokeStyle = "#333";
      ctx.lineWidth = 1;
      ctx.beginPath();
      ...
      ctx.stroke();
      if (((_g = scalesOptions.x.ticks) == null ? void 0 : _g.display) && this.config.data.labels) {
        ctx.fillStyle = scalesOptions.x.ticks.color || "#666";
        ctx.font = `${((_h = scalesOptions.x.ticks.font) == null ? void 0 : _h.size) || 10}px ${((_i = scalesOptions.x.ticks.font) == null ? void 0 : _i.family) || "Arial"}`;
...
var LineChart = class {
  ...
  render(ctx, bounds, progress) {
    ...
    if (!this.config.data.datasets.length)
      return;
    const legendHeight = ((_b = (_a = this.config.options) == null ? void 0 : _a.legend) == null ? void 0 : _b.display) ? 50 : 0;
    const chartBounds = {
      x: bounds.x + 50,
      y: bounds.y + legendHeight + 10,
      width: bounds.width - 80,
    ...
    if ((_d = (_c = this.config.options) == null ? void 0 : _c.legend) == null ? void 0 : _d.display) {
      this.renderLegend(ctx, bounds);
    }
    this.renderGrid(ctx, chartBounds);
    this.renderAxes(ctx, chartBounds);
...
var PieChart = class {
  ...
  render(ctx, bounds, progress) {
    ...
    if (!this.config.data.datasets.length)
      return;
    const legendHeight = ((_b = (_a = this.config.options) == null ? void 0 : _a.legend) == null ? void 0 : _b.display) ? 60 : 0;
  ...
  renderLegend(ctx, bounds) {
    var _a, _b, _c, _d, _e;
    const legendOptions = (_a = this.config.options) == null ? void 0 : _a.legend;
    if (!(legendOptions == null ? void 0 : legendOptions.display) || !this.config.data.labels)
      return;
...
var ScatterChart = class {
  ...
  renderGrid(ctx, bounds) {
    ...
    if ((_i = (_h = scalesOptions == null ? void 0 : scalesOptions.x) == null ? void 0 : _h.grid) == null ? void 0 : _i.display) {
      const gridLines = 5;
      for (let i = 0; i <= gridLines; i++) {
  ...
  renderAxes(ctx, bounds) {
    ...
    if ((_f = scalesOptions == null ? void 0 : scalesOptions.x) == null ? void 0 : _f.display) {
      ...
      ctx.lineTo(bounds.x + bounds.width, bounds.y + bounds.height);
      ctx.stroke();
      if ((_g = scalesOptions.x.ticks) == null ? void 0 : _g.display) {
        ctx.fillStyle = scalesOptions.x.ticks.color || "#666";
        ctx.font = `${((_h = scalesOptions.x.ticks.font) == null ? void 0 : _h.size) || 10}px ${((_i = scalesOptions.x.ticks.font) == null ? void 0 : _i.family) || "Arial"}`;
        ctx.textAlign = "center";
        ctx.textBaseline = "top";
...
var Chartie = class {
  ...
  setupResizeListener() {
    var _a;
    if (!((_a = this.config.options) == null ? void 0 : _a.responsive))
      return;
  ...
  getChartBounds() {
    var _a;
    const padding = ((_a = this.config.options) == null ? void 0 : _a.padding) || {};
  ...
  render() {
    ...
    if (!this.chartInstance)
      return;
    const animationOptions = (_a = this.config.options) == null ? void 0 : _a.animation;
    if ((animationOptions == null ? void 0 : animationOptions.duration) && animationOptions.duration > 0) {
      this.startAnimation();
    } else {
      this.renderFrame(1);
    }
  ...
  animateFrame() {
    ...
    const duration = ((_b = (_a = this.config.options) == null ? void 0 : _a.animation) == null ? void 0 : _b.duration) || 800;
    const progress = Math.min(elapsed / duration, 1);
    const easingType = ((_d = (_c = this.config.options) == null ? void 0 : _c.animation) == null ? void 0 : _d.easing) || "easeInOut";
  ...
  renderFrame(progress) {
    ...
    const backgroundColor = (_a = this.config.options) == null ? void 0 : _a.backgroundColor;
    if (backgroundColor) {
  ...
  destroy() {
    var _a;
    this.stopAnimation();
    (_a = this.chartInstance) == null ? void 0 : _a.destroy();
    this.chartInstance = null;
  }
};
